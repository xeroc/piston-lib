...
class Address(object):
    """ Address class
        ...
        :param str prefix: Network prefix (defaults to ``STEEM``)

        Example::

           Address("STEEMFN9r6VYzBK8EKtMewfNbfiGCr56pHDBFi")
    ...
    def __repr__(self) :
        """ Gives the hex representation of the STEEM address.
        """
        return repr(self.derivesha512address())

    def __str__(self) :
        """ Returns the readable STEEM address. This call is equivalent to
            ``format(Address, "STEEM")``
        """
...
class PublicKey(Address):
    """ This class deals with Public Keys and inherits ``Address``.
        ...
        Example:::
           ...
           PublicKey("STEEM6UtYWWs3rkZGV8JA86qrgkG6tyFksgECefKE1MiH4HkLD8PFGL")

        .. note:: By default, the networks deal with **compressed**
    ...
    def __repr__(self) :
        """ Gives the hex representation of the public key. """
        return repr(self._pk)

    def __str__(self) :
        """ Returns the readable public key. This call is equivalent to
            ``format(PublicKey, "STEEM")``
        """
...
class PrivateKey(PublicKey):
    ...
    def __repr__(self) :
        """ Gives the hex representation of the private key."""
        return repr(self._wif)

    def __str__(self) :
        """ Returns the readable (uncompressed wif format) private key. This
