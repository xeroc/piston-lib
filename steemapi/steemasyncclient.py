   ...
   def __init__(self, **kwargs):
      ...
      if "config_file" in kwargs:
         ...
         if "witness" in c:
            ...
            if "url" in self.witness and self.witness["url"] != None:
               witness_url_specified = True
            if (not "user" in self.witness) or (self.witness["user"] == None):
               self.witness["user"] = ""
            if (not "password" in self.witness) or (self.witness["password"] == None):
               self.witness["password"] = ""
            if (not "apis" in self.witness) or (self.witness["apis"] == None):
               self.witness["apis"] = {}
         ...
         if "wallet" in c:
            ...
            if "url" in self.wallet and self.wallet["url"] != None:
               wallet_url_specified = True
            if (not "user" in self.wallet) or (self.wallet["user"] == None):
               self.wallet["user"] = ""
            if (not "password" in self.wallet) or (self.wallet["password"] == None):
               self.wallet["password"] = ""
         if (not "witness" in c) and (not "wallet" in c):
